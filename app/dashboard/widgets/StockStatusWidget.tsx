...
export function StockStatusWidget() {
  ...
  return (
    <div className="h-full w-full bg-white dark:bg-slate-900 rounded-3xl p-8 shadow ring-1 ring-slate-200 dark:ring-slate-800 flex flex-col justify-between">
      ...
      <div className="mt-2 grid grid-cols-2 gap-6">
        <div className="h-52 bg-slate-50/50 dark:bg-slate-950 rounded-3xl border border-slate-100 dark:border-slate-800 flex flex-col items-center justify-between p-8 transition-all hover:bg-slate-50 dark:hover:bg-slate-900">
