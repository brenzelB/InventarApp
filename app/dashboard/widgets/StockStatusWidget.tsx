...
export function StockStatusWidget() {
  ...
  return (
    <div className="h-full w-full bg-white dark:bg-widget rounded-3xl p-6 shadow ring-1 ring-slate-200 dark:ring-slate-700 flex flex-col justify-between">
      ...
      <div className="mt-4 grid grid-cols-2 gap-4">
        <div className="bg-slate-50 dark:bg-widget/50 p-4 rounded-2xl">
