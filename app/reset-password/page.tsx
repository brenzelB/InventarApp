  ...
  if (pageState === "loading") {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-8">
        ...
        <p className="text-sm text-slate-500 font-medium">Token wird geprüft…</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
          ...
          <h2 className="text-2xl font-black tracking-wider text-slate-900">Link ungültig oder abgelaufen</h2>
    ...
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center py-12">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-black tracking-wider text-slate-900">Passwort erfolgreich geändert!</h2>
  ...
  return (
    <div className="flex min-h-[60vh] flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-black tracking-tight text-slate-900 uppercase tracking-tighter">
          Passwort festlegen
        </h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-2xl sm:px-10 border border-slate-200">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
               <label className="block text-[10px] font-semibold text-slate-700 dark:text-slate-400 uppercase tracking-[0.2em] mb-2 pl-1">Vollständiger Name (Vor- & Nachname)</label>
            ...
            <div className="text-xs text-slate-500 space-y-1 -mt-2 font-bold">
            ...
            {confirmPassword && (
              <p className={`text-xs -mt-4 font-bold ${password === confirmPassword ? "text-green-600" : "text-red-600"}`}>
