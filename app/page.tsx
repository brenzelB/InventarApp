  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
      <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6">
        Willkommen zur <span className="text-accent dark:text-indigo-400">Inventar App</span>
      </h1>
      ...
      <div className="flex gap-4">
        ...
        <Link href="/login" className="rounded-2xl bg-white dark:bg-widget px-6 py-3 text-sm font-semibold text-slate-900 dark:text-white shadow-sm ring-1 ring-inset ring-slate-300 dark:ring-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all">
          Anmelden
        </Link>
      </div>
    </div>
